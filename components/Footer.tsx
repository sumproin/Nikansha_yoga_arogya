        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              NIKANSHA YOGAAROGYA STUDIO & WELLNESS is a yoga center in Indirapuram, Ghaziabad for yoga classes, online yoga, meditation, pranayama, prenatal care, face yoga, and therapeutic wellness.
            </p>
